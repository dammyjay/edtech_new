...
//   `SELECT q.title, r.score, r.total_questions, r.created_at
//    FROM quiz_submissions r
//    JOIN quizzes q ON q.id = r.quiz_id
//    WHERE r.student_id = $1 AND r.quiz_id = $2`,
//   [studentId, quizId]
// );
...
//   res.setHeader(
//     "Content-Disposition",
//     `attachment; filename=Quiz_Report_${student.fullname.replace(/\s+/g, "_")}.pdf`
//   );
...
//   doc.text(`Score: ${quiz.score} / ${quiz.total_questions}`);
//   doc.text(`Date Taken: ${new Date(quiz.created_at).toLocaleString()}`);
